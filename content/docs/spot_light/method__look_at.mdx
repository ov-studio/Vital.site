---
title: self:look_at
description: Rotates the spot light so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a spot light at the world origin"

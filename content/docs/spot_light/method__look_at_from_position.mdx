...
description: Moves the spot light to the given position and rotates it to look at the target
badge: client
---
...
```lua lineNumbers title="Position and orient a spot light in one call"

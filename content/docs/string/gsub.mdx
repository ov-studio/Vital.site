...
| `string`, `table`, `function` | replacement | Replacement string, table, or function |
| `number` | max_replacements | Maximum number of replacements to make |

### Returns

| Type | Name | Description |
|------|------|-------------|
| `string` | result | Modified string with replacements |
| `number` | count | Number of substitutions that occurred |

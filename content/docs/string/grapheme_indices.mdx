...
<Callout type="warn">
This function returns byte positions (like `util.string.codepoint`, `util.string.codes`, `util.string.offset`, `util.string.charpos` and `util.string.invalidoffset`), not character positions.

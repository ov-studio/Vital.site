...
|------|------|-------------|
| `string` | input | String to parse and convert to its appropriate primitive type |

### Returns

| Type | Name | Description |
|------|------|-------------|
| `any` | result | Converted value:<br/>• `nil` - if input is "nil"<br/>• `boolean` - if input is "true" or "false"<br/>• `number` - if input represents a valid number<br/>• `default` - if input cannot be converted to other types |

...
| Type | Name | Description |
|------|------|-------------|
| `promise` / `bool` | ctx | Returns promise context containing the following fields on successful execution:<br/>• `resolve` (function) - callable function to resolve the promise with passed arguments<br/>• `reject` (function) - callable function to reject the promise with passed arguments<br/>or false on failure |

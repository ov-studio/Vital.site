...
|------|------|-------------|
| `table` | actions | Table describing the schema changes to apply<br/>See **Actions** below |

### Actions

| Key | Type | Description |
|-----|------|-------------|
| `add` | `table` | Map of column names to their column definitions to add to the table<br/>See **Column Definitions** below |
| `modify` | `table` | Map of column names to their column definitions to modify on the table<br/>See **Column Definitions** below |

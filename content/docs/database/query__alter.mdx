...
|-----|------|-------------|
| `add` | `table` | Map of column names to their column definitions to add to the table<br/>See **Definitions** below |
| `modify` | `table` | Map of column names to their column definitions to modify on the table<br/>See **Definitions** below |

...
<Callout type="info">
  **Links are displayed as-is** — no validation is performed on URL format or reachability.
</Callout>

| Key | Type | Default | Description |
|---|---|---|---|
| `discord_invite` | `string` | `""` | Discord server invite URL shown in the client UI |
| `website` | `string` | `""` | Community or project website URL shown in the client UI |

...
author_url: "https://github.com/YourName" # Required for vault
banner: "https://raw.githubusercontent.com/<org>/<repo>/main/resources/<name>/banner.png" # Required for vault
tagline: "One-line summary of what this resource does" # Required for vault
featured: false # Required for vault

description: |  # Required for vault
  Longer description shown in the Vault modal.
  Supports multiple lines like this.

tags:  # Required for vault
  - "utility"

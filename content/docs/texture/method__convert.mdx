...
Formats are ordered highest to lowest quality — or equivalently, lowest to highest VRAM savings.<br/>
Unlike [`self:compress`](/docs/texture/method/compress), converted textures remain uncompressed in VRAM and can be converted again at any time.

...
description: Retrieves the currently applied sampling filter override
badge: Client
---
...
|------|------|-------------|
| [`core.texture.texture_filter`](/docs/texture/enum/texture_filter) | mode | Sampling filter of the texture |

...
description: Moves the area light to the given position and rotates it to look at the target
badge: client
---
...
```lua lineNumbers title="Position and orient a area light in one call"

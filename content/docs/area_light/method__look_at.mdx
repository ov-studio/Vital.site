---
title: self:look_at
description: Rotates the area light so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a area light at the world origin"

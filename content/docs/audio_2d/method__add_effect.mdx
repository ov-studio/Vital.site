...
|------|------|-------------|
| `string` | name | Unique identifier for this effect slot |
...
| Type | Name | Description |
|------|------|-------------|
| `int` \| `bool` | id | Index of the newly added effect on success, `false` otherwise |
...
local id = entity:add_effect("my_reverb", "reverb", {
    room_size = 0.8,
    wet = 0.5,
    dry = 0.5
})

...
| Key | Type | Description |
|-----|------|-------------|
| `bands` | `table` | Array of 6 entries, each the gain in decibels for that band |
...
| Key | Type | Description |
|-----|------|-------------|
| `bands` | `table` | Array of 10 entries, each the gain in decibels for that band |
...
| Key | Type | Description |
|-----|------|-------------|
| `bands` | `table` | Array of 21 entries, each the gain in decibels for that band |
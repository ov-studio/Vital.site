...
description: Moves the point light to the given position and rotates it to look at the target
badge: client
---
...
```lua lineNumbers title="Position and orient a point light in one call"

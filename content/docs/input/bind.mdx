...
|------|------|-------------|
| `number` | key | Key or button to listen to<br/>Refer [**util.input.key**](/docs/input/enum/key) enum |
...
| Type | Name | Description |
|------|------|-------------|
| `number` | key | Key enum value of the key or button that triggered the handler |

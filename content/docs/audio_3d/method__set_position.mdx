...
description: Sets the position of the audio-3d instance relative to its parent
badge: client
---
...
```lua lineNumbers title="Position an audio-3d instance relative to its parent"

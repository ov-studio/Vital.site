...
description: Translates the audio-3d instance by an offset in the parent's coordinate space
badge: client
---
...
```lua lineNumbers title="Move an audio-3d instance along the parent's Z axis"

...
|------|------|-------------|
| `vector2` | position | Screen-space pixel coordinates to convert to world-space coordinates |
...
| Type | Name | Description |
|------|------|-------------|
| `vector3` | position | World-space position at the given depth or `{-1, -1, -1}` if off-screen |

...
| `alignment[horizontal, vertical]` | alignment | • Horizontal alignment: <br/>&emsp;•`"left"` / `0` <br/>&emsp;•`"center"` / `1` <br/>&emsp;•`"right"` / `2` <br/>&emsp;•`"fill"` / `3` <br/><br/>• Vertical alignment: <br/>&emsp;•`"top"` / `0` <br/>&emsp;•`"center"` / `1` <br/>&emsp;•`"bottom"` / `2` <br/>&emsp;•`"fill"` / `3` |

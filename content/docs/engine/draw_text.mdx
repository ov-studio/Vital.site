...
| [`core.engine.horizontal_alignment`](/docs/engine/enum/horizontal_alignment) | horizontal_alignment | Horizontal alignment of the text within the bounding box |
| [`core.engine.vertical_alignment`](/docs/engine/enum/vertical_alignment) | vertical_alignment | Vertical alignment of the text within the bounding box |
| `bool` | clip | When `true`, text is clipped to the bounding box |
| `bool` | wordwrap | When `true`, text wraps at the bounding box width |
| `int` | stroke | Outline thickness in pixels<br/>Set to `0` to disable |

      ...
      <footer>
        <div className="footer-main">
          ...
          <div className="footer-nav">
            ...
            <div className="footer-nav-col"><h4>Community</h4><ul><li><a href="#">GitHub</a></li><li><a href="#">Discord</a></li><li><a href="https://ko-fi.com/ovstudio">Ko-fi</a></li><li><a href="#">Contributing</a></li></ul></div>
          </div>
        </div>
      </footer>
    </>

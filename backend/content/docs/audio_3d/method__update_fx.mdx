...
description: Updates parameters of an existing audio effect on the audio-3d instance's effect chain
badge: client
---
...
```lua lineNumbers title="Update parameters of an existing effect on an audio-3d instance"
...
```lua lineNumbers title="Update EQ bands on an audio-3d instance"
local entity = core.audio_3d.create("sounds/ambient.ogg")

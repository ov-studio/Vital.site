    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Format: WAV', status: 'completed' },
          { label: 'Format: MP3', status: 'completed' },
          { label: '[Client] Enum: core.audio_3d.effect', status: 'pending' },
          { label: '[Client] API: core.audio_3d.create', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:is_type', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:get_type', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:destroy', status: 'pending' },
          ...
          { label: '[Client] API: self<audio_3d>:get_pitch_scale', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:get_panning_strength', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:get_playback_position', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:get_doppler_tracking', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:get_emission_angle', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:set_volume', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:set_paused', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:set_max_distance', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:set_attenuation', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:set_pitch_scale', status: 'pending' },
          ...
          { label: '[Client] API: self<audio_3d>:add_effect', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:remove_effect', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:list_effects', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:set_effect_enabled', status: 'pending' },
          { label: '[Client] API: self<audio_3d>:is_effect_enabled', status: 'pending' }
        ]
      },
      {
        // TODO: WIP

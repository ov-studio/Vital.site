    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '[Client] API: self<camera>:get_h_offset', status: 'completed' },
          { label: '[Client] API: self<camera>:get_v_offset', status: 'completed' },
          ...
          { label: '[Client] API: self<camera>:set_h_offset', status: 'completed' },
          { label: '[Client] API: self<camera>:set_v_offset', status: 'completed' },

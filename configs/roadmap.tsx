    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label:  '[Client] API: self<camera>:is_type',                           status: 'completed' },
          { label:  '[Client] API: self<camera>:get_type',                          status: 'completed' },
          { label:  '[Client] API: self<camera>:destroy',                           status: 'completed' },
          { label:  '[Client] API: self<camera>:is_active',                         status: 'completed' },
          { label:  '[Client] API: self<camera>:is_position_behind',                status: 'completed' },
          { label:  '[Client] API: self<camera>:is_position_in_frustum',            status: 'completed' },
          { label:  '[Client] API: self<camera>:is_auto_exposure_enabled',          status: 'completed' },
          { label:  '[Client] API: self<camera>:is_dof_blur_far_enabled',           status: 'completed' },
          { label:  '[Client] API: self<camera>:is_dof_blur_near_enabled',          status: 'completed' },
          { label:  '[Client] API: self<camera>:get_fov',                           status: 'completed' },
          { label:  '[Client] API: self<camera>:get_size',                          status: 'completed' },
          { label:  '[Client] API: self<camera>:get_near_clip',                     status: 'completed' },
          { label:  '[Client] API: self<camera>:get_far_clip',                      status: 'completed' },
          { label:  '[Client] API: self<camera>:get_transform',                     status: 'completed' },
          { label:  '[Client] API: self<camera>:get_projection',                    status: 'completed' },
          { label:  '[Client] API: self<camera>:get_projection_matrix',             status: 'completed' },
          { label:  '[Client] API: self<camera>:get_horizontal_offset',             status: 'completed' },
          { label:  '[Client] API: self<camera>:get_vertical_offset',               status: 'completed' },
          { label:  '[Client] API: self<camera>:get_keep_aspect_mode',              status: 'completed' },
          { label:  '[Client] API: self<camera>:get_doppler_tracking',              status: 'completed' },
          { label:  '[Client] API: self<camera>:get_auto_exposure_scale',           status: 'completed' },
          { label:  '[Client] API: self<camera>:get_auto_exposure_speed',           status: 'completed' },
          { label:  '[Client] API: self<camera>:get_auto_exposure_min_sensitivity', status: 'completed' },
          { label:  '[Client] API: self<camera>:get_auto_exposure_max_sensitivity', status: 'completed' },
          { label:  '[Client] API: self<camera>:get_dof_blur_amount',               status: 'completed' },
          { label:  '[Client] API: self<camera>:get_dof_blur_far_distance',         status: 'completed' },
          { label:  '[Client] API: self<camera>:get_dof_blur_far_transition',       status: 'completed' },
          { label:  '[Client] API: self<camera>:get_dof_blur_near_distance',        status: 'completed' },
          ...
          { label:  '[Client] API: self<camera>:set_far_clip',                      status: 'completed' },
          { label:  '[Client] API: self<camera>:set_projection',                    status: 'completed' },
          { label:  '[Client] API: self<camera>:set_horizontal_offset',             status: 'completed' },
          { label:  '[Client] API: self<camera>:set_vertical_offset',               status: 'completed' },
          { label:  '[Client] API: self<camera>:set_keep_aspect_mode',              status: 'completed' },
          { label:  '[Client] API: self<camera>:set_doppler_tracking',              status: 'completed' },
          { label:  '[Client] API: self<camera>:set_auto_exposure_enabled',         status: 'completed' },
          { label:  '[Client] API: self<camera>:set_auto_exposure_scale',           status: 'completed' },
          { label:  '[Client] API: self<camera>:set_auto_exposure_speed',           status: 'completed' },
          { label:  '[Client] API: self<camera>:set_auto_exposure_min_sensitivity', status: 'completed' },
          { label:  '[Client] API: self<camera>:set_auto_exposure_max_sensitivity', status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_amount',               status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_far_enabled',          status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_far_distance',         status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_far_transition',       status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_near_enabled',         status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_near_distance',        status: 'completed' },
          { label:  '[Client] API: self<camera>:set_dof_blur_near_transition',      status: 'completed' },
          { label:  '[Client] API: self<camera>:project_ray_normal',                status: 'completed' },
          { label:  '[Client] API: self<camera>:project_local_ray_normal',          status: 'completed' },
          { label:  '[Client] API: self<camera>:project_ray_origin',                status: 'completed' },
          { label:  '[Client] API: self<camera>:project_position',                  status: 'completed' },
          { label:  '[Client] API: self<camera>:unproject_position',                status: 'completed' }
        ]
      },
      {
        label: 'Webview',
        ...
        items: [
          ...
          { label:  '[Client] API: self<webview>:is_forward_input',     status: 'completed' },
          ...
          { label:  '[Client] API: self<webview>:get_z_index',          status: 'completed' },
          ...
          { label:  '[Client] API: self<webview>:set_focussed',         status: 'completed' },
          { label:  '[Client] API: self<webview>:set_z_index',          status: 'completed' },
      ...
      },
      {
        ...
        items: [
          ...
          { label:  '[Client] API: self<audio_2d>:is_paused',             status: 'completed' },
          { label:  '[Client] API: self<audio_2d>:is_looped',             status: 'completed' },
          { label:  '[Client] API: self<audio_2d>:is_autoplayed',         status: 'completed' },
          { label:  '[Client] API: self<audio_2d>:is_fx_enabled',         status: 'completed' },
          { label:  '[Client] API: self<audio_2d>:get_volume',            status: 'completed' },
          ...
          { label:  '[Client] API: self<audio_2d>:set_volume',            status: 'completed' },
          { label:  '[Client] API: self<audio_2d>:set_paused',            status: 'completed' },
          { label:  '[Client] API: self<audio_2d>:set_looped',            status: 'completed' },
      ...
      },
      {
        ...
        items: [
          ...
          { label:  '[Client] API: self<audio_3d>:is_type',                                  status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_type',                                 status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:destroy',                                  status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:is_playing',                               status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:is_paused',                                status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:is_looped',                                status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:is_autoplayed',                            status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:is_emission_angle_enabled',                status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:is_fx_enabled',                            status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_position',                             status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_global_position',                      status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_volume',                               status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_max_volume',                           status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_pitch_scale',                          status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_panning_strength',                     status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_playback_position',                    status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_unit_size',                            status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_max_distance',                         status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_attenuation_model',                    status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_doppler_tracking',                     status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_emission_angle',                       status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_emission_angle_filter_attenuation_db', status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_attenuation_filter_cutoff_hz',         status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:get_attenuation_filter_db',                status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_position',                             status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_global_position',                      status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_volume',                               status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_max_volume',                           status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_paused',                               status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_looped',                               status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_pitch_scale',                          status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_panning_strength',                     status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_unit_size',                            status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_max_distance',                         status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_attenuation_model',                    status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_doppler_tracking',                     status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_emission_angle_enabled',               status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_emission_angle',                       status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_emission_angle_filter_attenuation_db', status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_attenuation_filter_cutoff_hz',         status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_attenuation_filter_db',                status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:set_fx_enabled',                           status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:translate',                                status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:translate_local',                          status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:play',                                     status: 'completed' },
          { label:  '[Client] API: self<audio_3d>:stop',                                     status: 'completed' },

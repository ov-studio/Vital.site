    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '[Client] API: self<camera>:get_camera_transform', status: 'completed' },
          { label: '[Client] API: self<camera>:get_camera_projection', status: 'completed' },
          ...
          { label: '[Client] API: self<camera>:get_near', status: 'completed' },
          { label: '[Client] API: self<camera>:get_far', status: 'completed' },
          ...
          { label: '[Client] API: self<camera>:set_orthogonal', status: 'completed' },
          { label: '[Client] API: self<camera>:set_fov', status: 'completed' },
          { label: '[Client] API: self<camera>:set_size', status: 'completed' },
          { label: '[Client] API: self<camera>:set_near', status: 'completed' },
          { label: '[Client] API: self<camera>:set_far', status: 'completed' },

    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Command: help', status: 'completed' },
          { label: 'Command: info', status: 'pending' },
          { label: 'Command: version', status: 'completed' },
          { label: 'Command: clear', status: 'completed' },
          { label: 'Command: crun/srun <code>', status: 'completed' },
          { label: 'Command: kick <id>', status: 'pending' },
          { label: 'Command: players', status: 'pending' },
          { label: 'Command: refresh', status: 'completed' },
          { label: 'Command: start <name>', status: 'completed' },
          { label: 'Command: stop <name>', status: 'completed' },
          { label: 'Command: restart <name>', status: 'completed' },
          { label: 'Command: start_all', status: 'completed' },
          { label: 'Command: stop_all', status: 'completed' },
          { label: 'Command: restart_all', status: 'completed' },
          { label: 'Command: shutdown', status: 'completed' }
        ],
      },
      {

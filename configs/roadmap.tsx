    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Encoding: Base64', status: 'completed' },
          { label: 'Algorithm: AES128', status: 'completed' },
          { label: 'Algorithm: AES192', status: 'completed' },
          { label: 'Algorithm: AES256', status: 'completed' },
    ...
    cards: [
      {
        ...
        items: [
          ...
          { label: 'Load from raw buffer', status: 'completed' },
          { label: 'Instantiate / destroy instances', status: 'completed' },
          { label: 'Synced spawn with per-peer authority assignment', status: 'completed' },
          { label: 'Transform (position / rotation)', status: 'completed' },
          { label: 'Animation (play / stop / pause / resume)', status: 'completed' },
          { label: 'Animation speed control', status: 'completed' },

...
export interface RoadmapCard {
  id: string;          // auto-generated from label, do not set manually
  label: string;
  desc: string;
  icon: string;
  priority?: string;
...
// ── Data ─────────────────────────────────────────────────────────────────────
export const Roadmap_Sections: RoadmapSection[] = build([
  ...
  // ── FOUNDATION ─────────────────────────────────────────────────────────────
  {
    ...
    cards: [
      ...
      {
        label: 'Resource',
        desc: 'Resource loading and management',
        icon: ICON.display,
        items: [],
      },
      {
        label: 'Console',
        desc: 'In-engine console and logging',
        icon: ICON.display,
        items: [],
      },
    ],
  ...
  // ── UI ─────────────────────────────────────────────────────────────────────
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: 'Grab viewport frame as image',
        icon: ICON.render,
        items: [

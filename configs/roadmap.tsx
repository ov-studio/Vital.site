    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '[Shared] API: util.string.detab', status: 'todo' },
          ...
          { label: '[Shared] API: util.string.insert', status: 'todo' },
          { label: '[Shared] API: util.string.remove', status: 'todo' },
          { label: '[Shared] API: util.string.codepoint', status: 'todo' },
          { label: '[Shared] API: util.string.codes', status: 'todo' },
          { label: '[Shared] API: util.string.next', status: 'todo' },
          { label: '[Shared] API: util.string.title', status: 'todo' },
          { label: '[Shared] API: util.string.fold', status: 'todo' },
          { label: '[Shared] API: util.string.ncasecmp', status: 'todo' },
          { label: '[Shared] API: util.string.offset', status: 'todo' },
          { label: '[Shared] API: util.string.charpos', status: 'todo' },
          { label: '[Shared] API: util.string.isvalid', status: 'todo' },
          { label: '[Shared] API: util.string.invalidoffset', status: 'todo' },
          { label: '[Shared] API: util.string.clean', status: 'todo' },
          { label: '[Shared] API: util.string.isnfc', status: 'todo' },
          { label: '[Shared] API: util.string.normalize_nfc', status: 'todo' },
          { label: '[Shared] API: util.string.width', status: 'todo' },
          { label: '[Shared] API: util.string.widthindex', status: 'todo' },
          { label: '[Shared] API: util.string.grapheme_indices', status: 'todo' },
          { label: '[Shared] API: util.string.escape', status: 'todo' },
          { label: '[Shared] API: util.string.charpattern', status: 'todo' }
        ]
      },
      {
        label: 'Table',

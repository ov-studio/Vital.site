...
export const Roadmap: RoadmapSection[] = build([
...

  {
    ...
    cards: [
      ...
      {
        label: 'Entity Sync',
        desc:  'ISyncable replication — delta transforms, spawn/destroy, authority, and client interpolation for any synced entity',
        icon:  <lucide.Users {...config_site.info.lucide}/>,
        items: [
          { label: 'ISyncable base for Model / PhysicsBody',     status: 'completed' },

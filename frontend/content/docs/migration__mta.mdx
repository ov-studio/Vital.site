...
Vital.sandbox runs on **Godot 4 + C++17** with a purpose-built Lua sandbox. The rendering stack, physics engine, networking layer, and asset pipeline are fully configurable. Asset formats, the resource system, and scripting patterns differ from MTA.

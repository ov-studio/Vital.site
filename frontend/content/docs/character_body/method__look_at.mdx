---
title: self:look_at
description: Rotates the character body so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a character body at the world origin"

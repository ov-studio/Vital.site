...
description: Moves the character body by a motion vector, stopping and reporting the first collision encountered along the way
badge: client
---
...
```lua lineNumbers title="Move a character body and detect collisions"

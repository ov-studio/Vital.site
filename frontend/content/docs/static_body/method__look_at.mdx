---
title: self:look_at
description: Rotates the static body so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a static body at the world origin"

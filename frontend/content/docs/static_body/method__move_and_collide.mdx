...
description: Moves the static body by a motion vector, stopping and reporting the first collision encountered along the way
badge: client
---
...
```lua lineNumbers title="Move a static body and detect collisions"

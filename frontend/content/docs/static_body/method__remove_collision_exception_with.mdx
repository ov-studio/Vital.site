...
description: Removes a previously added collision exception from the static body, restoring collision between the two bodies
badge: client
---
...
```lua lineNumbers title="Remove a collision exception on a static body"

---
title: self:look_at
description: Rotates the animatable body so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a animatable body at the world origin"

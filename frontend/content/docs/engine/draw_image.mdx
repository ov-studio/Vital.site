...
| `string` \| `image` \| `svg` \| `rendertarget` | material | Image source:<br/>• `string` - file path to an image asset<br/>• `image` - pre-loaded image instance<br/>• `rendertarget` - rendertarget instance<br/>• `svg` - svg instance |

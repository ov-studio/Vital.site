---
title: self:look_at
description: Rotates the vehicle wheel so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a vehicle wheel at the world origin"

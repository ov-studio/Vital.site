...
description: Removes a previously added collision exception from the vehicle body, restoring collision between the two bodies
badge: client
---
...
```lua lineNumbers title="Remove a collision exception on a vehicle body"

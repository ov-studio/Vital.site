---
title: self:look_at
description: Rotates the vehicle body so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a vehicle body at the world origin"

...
description: Moves the vehicle body by a motion vector, stopping and reporting the first collision encountered along the way
badge: client
---
...
```lua lineNumbers title="Move a vehicle body and detect collisions"

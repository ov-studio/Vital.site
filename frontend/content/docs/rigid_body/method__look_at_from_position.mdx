...
description: Moves the rigid body to a position and rotates it so its -Z axis points toward the given target
badge: client
---
...
```lua lineNumbers title="Position and point a rigid body"

---
title: self:look_at
description: Rotates the rigid body so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a rigid body at the world origin"

---
title: self:look_at
description: Rotates the collision shape so its -Z axis points toward the given world-space target
badge: client
---
...
```lua lineNumbers title="Point a collision shape at the world origin"

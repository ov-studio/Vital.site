...
|---|---|---|---|---|---|
| `name` | `string` | No | `ref` | Sandbox, Vault | Display name for the resource |
| `author` | `string` | No | `""` | Sandbox, Vault | Free-text author/credit string |
| `version` | `string` | No | `""` | Sandbox, Vault | Free-text version string |
| `author_url` | `string` | No | `https://github.com/<author>` | Vault | Link wrapped around the author name |
| `banner` | `string` | No | `null` | Vault | Full URL to a banner image |
| `tagline` | `string` | No | `"N/A"` | Vault | Short one-line summary |
| `featured` | `boolean` | No | `false` | Vault | Pins the resource to the top of Vault |
| `description` | `string` | No | `"N/A"` | Vault | Longer brief summary |
| `tags` | `string[]` | No | `[]` | Vault | Filters to be used:<br/>• `animation`<br/>• `asset`<br/>• `gamemode`<br/>• `gfx`<br/>• `library`<br/>• `map`<br/>• `physx`<br/>• `sfx`<br/>• `shader`<br/>• `ui`<br/>• `utility`<br/>• `vfx` |
